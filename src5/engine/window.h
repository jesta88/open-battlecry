...
typedef struct
{
    u16 type;
    union {
        struct { u16 width; u16 height; } resize;
        struct { u16 keycode; u16 scancode; u8 modifiers; bool pressed; } key;
        struct { u16 character; } text;
        struct { u16 button; u16 x; u16 y; } mouse;
    };
} wk_event;
